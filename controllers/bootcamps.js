...
exports.getBootcamp = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json({ succcess: true, data: bootcamp });
});
...
exports.getBootcampsInRadius = asyncHandler(async (req, res, next) => {
  ...
  //Earth radius = 3,963 mi / 6378 kilometers
  ...
  res.status(200).json({ succcess: true, count: bootcamps.length, data: bootcamps });
});
